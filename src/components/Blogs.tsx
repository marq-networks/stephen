    ...
    <section className="py-20 px-6 bg-gray-100">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-800 text-base max-w-lg mx-auto">
        ...
        <div className="flex justify-between items-center">
          <button className="bg-[#46c34c] hover:bg-[#479f78] text-white px-6 py-2.5 rounded-full transition-colors duration-200 text-sm font-medium">
            See More
          </button>
