        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              {/* Size Selection */}
              <div>
                <h3 className="text-white text-lg font-semibold mb-3">Size</h3>
              ...
              {/* Color Selection */}
              <div>
                <h3 className="text-white text-lg font-semibold mb-3">Color</h3>
                <div className="flex flex-wrap gap-3">
              ...
              <div>
                ...
                <div className="flex items-center space-x-4">
                  <button
                    ...
                    className="w-10 h-10 rounded-lg border border-gray-600 text-gray-400 hover:border-gray-400"
                  >
                    -
                  </button>
